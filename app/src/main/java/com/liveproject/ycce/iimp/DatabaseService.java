...
//Fail Return : null sent on not found.
    ...
    public static Member getMember(String id) {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            MemberAddress ma = new MemberAddress(cursor.getString(13), cursor.getString(14), cursor.getString(15), cursor.getString(16), cursor.getString(17), cursor.getString(18), cursor.getString(19));
