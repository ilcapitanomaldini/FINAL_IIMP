...
public class Constants {
    ...
    public static final String GETCONDITIONALGROUPCONDITIONS_URL = "getconditionalgroupconditions";
    public static final String GETCUSTOMIZEDGROUPMEMBERS_URL = "getcustomizedgroupmembers";
